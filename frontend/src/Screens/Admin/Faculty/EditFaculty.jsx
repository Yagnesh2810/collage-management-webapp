...
const EditFaculty = () => {
  ...
  const searchFacultyHandler = (e) => {
    ...
    axios
      .post(`${baseApiURL()}/faculty/details/getDetails`, { employeeId: search }, { headers })
      .then((response) => {
        toast.dismiss()
        ...
        >
          ...
          {previewImage && (
            <div className="w-full flex justify-center items-center">
              <img src={process.env.REACT_APP_MEDIA_LINK + "/" + previewImage} alt="faculty" className="h-36" />
            </div>
          )}
          {!previewImage && data.profile && (
            <div className="w-full flex justify-center items-center">
              <img src={process.env.REACT_APP_MEDIA_LINK + "/" + data.profile} alt="faculty" className="h-36" />
            </div>
          )}
