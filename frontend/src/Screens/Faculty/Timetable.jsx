      ...
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          ...
          <select
            ...
            onChange={(e) => setAddSelected({ ...addselected, branch: e.target.value })}
          >
          ...
          <select
            onChange={(e) => setAddSelected({ ...addselected, semester: e.target.value })}
          ...
          <input type="file" name="upload" id="upload" accept="image/*" hidden onChange={handleFileChange} />
          <button className="bg-blue-500 text-white mt-8 px-4 py-2 rounded-sm" onClick={addTimetableHandler}>
            Add Timetable
          </button>
          {previewUrl && <img className="mt-6" src={previewUrl} alt="timetable" />}
        </div>
      </div>
    </div>
  )
